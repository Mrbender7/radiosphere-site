export type Language = "fr" | "en" | "es" | "de" | "ja" | "it" | "nl" | "pt" | "pt-BR" | "pl" | "zh" | "zh-TW" | "tr" | "ru" | "uk" | "sv" | "id" | "ms" | "th" | "ar" | "hi";
...
export const LANGUAGE_OPTIONS: { value: Language; flag: string; flagUrl: string; label: string }[] = [
  ...
  { value: "zh", flag: "🇨🇳", flagUrl: "https://flagcdn.com/w40/cn.png", label: "简体中文" },
  { value: "zh-TW", flag: "🇹🇼", flagUrl: "https://flagcdn.com/w40/tw.png", label: "繁體中文" },
...
const translations = {
  ...
  "zh-TW": {
    "seo.title": "RadioSphere — 免費無廣告電臺 | TimeBack 時光機",
    "seo.description": "收聽全球 50,000+ 免費電臺。獨家功能：TimeBack 時光機可讓您回放任何電臺最多 30 分鐘。無廣告，無需註冊。",
    "nav.home": "首頁",
    "nav.search": "搜尋",
    "nav.explore": "搜尋與探索",
    "nav.favorites": "收藏",
    ...
    "nav.settings": "設定",
    "nav.about": "關於",
    "sidebar.stationCount": "超過50,000個電臺，覆蓋230多個國家，免費，無需註冊，無額外廣告。",
    "sidebar.tbmTeaser": "我們的獨家功能：TimeBack Machine — 倒帶直播廣播，重聽最近5分鐘，將節目錄製為MP3。讓您回到過去的線上廣播播放器。",
    "sidebar.tbmHowItWorks": "如何使用？",
    "sidebar.podcastTeaser": "想聽播客嗎？",
    "tbmModal.title": "TimeBack Machine — 如何使用？",
    "tbmModal.intro": "TimeBack Machine是RadioSphere.be的獨家功能，徹底改變了線上廣播收聽體驗。再也不會錯過重要的直播時刻！",
    "tbmModal.bufferTitle": "🔄 智慧緩衝（5分鐘）",
    "tbmModal.bufferDesc": "當您收聽電臺時，RadioSphere.be會自動在迴圈緩衝區中錄製最近5分鐘的內容。無需啟用任何功能：完全自動且透明。",
    "tbmModal.rewindTitle": "⏪ 倒帶直播",
    "tbmModal.rewindDesc": "錯過了新聞、歌曲或重要時刻？開啟TimeBack Machine，最多可倒退5分鐘。使用-15s/+15s按鈕或拖動時間線精確導航。",
    "tbmModal.recordTitle": "🔴 錄製為MP3",
    "tbmModal.recordDesc": "按下REC，直接從播放器錄製最多10分鐘的廣播為MP3。非常適合儲存訪談、音樂或完整節目。",
    "tbmModal.iconTitle": "💡 閃爍的TBM圖示",
    "tbmModal.iconDesc": "當播放器中的TBM圖示閃爍時，表示緩衝區正在活動並持續錄製。點選它可開啟TimeBack Machine，訪問最近幾分鐘的收聽內容。",
    "tbmModal.liveTitle": "📡 返回直播",
    "tbmModal.liveDesc": "隨時按下「直播」即可立即返回電臺的實時流媒體。",
    "tbmModal.close": "知道了",
    "app.downloadTitle": "移動應用",
    "app.downloadDesc": "使用Android應用隨時隨地收聽廣播。",
    "app.downloadBtn": "即將推出",
    "footer.tagline": "收聽全球數千個廣播電臺的高階網路播放器。",
    "footer.links": "實用連結",
    "footer.contact": "聯絡我們",
    "footer.rights": "版權所有。",
    "privacy.title": "隱私政策",
    ...
    "privacy.dataCollectionDesc": "RadioSphere.be不收集任何可識別的個人資料。使用服務無需註冊。",
    "privacy.localStorage": "本地儲存",
    "privacy.localStorageDesc": "所有資料僅儲存在您的裝置上：",
    "privacy.localStorageFavorites": "您的收藏電臺",
    "privacy.localStorageLang": "您的語言偏好",
    "privacy.localStorageRecent": "您最近收聽的電臺",
    "privacy.localStoragePrefs": "您的介面設定",
    "privacy.analytics": "受眾測量（Umami Analytics）",
    "privacy.analyticsDesc": "我們使用Umami Analytics，一款尊重隱私且符合GDPR的分析解決方案。Umami不收集可識別的個人資料，不使用Cookie，所有資料均已匿名化。",
    "privacy.analyticsNoCookies": "無跟蹤Cookie",
    "privacy.analyticsAnonymous": "完全匿名化的資料",
    "privacy.analyticsGDPR": "符合GDPR",
    "privacy.analyticsNoPersonal": "不收集可識別的個人資料",
    "privacy.analyticsLearnMore": "瞭解更多關於Umami的隱私政策",
    "privacy.thirdParty": "第三方服務",
    "privacy.thirdPartyDesc": "音訊流由廣播電臺透過Radio Browser API直接提供。流媒體可能包含由電臺自行插入的廣告——RadioSphere.be無法過濾或遮蔽這些廣告。",
    "privacy.thirdPartyUmami": "Umami Analytics（cloud.umami.is）用於匿名測量網站流量。無Cookie，無個人資料。",
    "privacy.permissions": "網路瀏覽器",
    "privacy.permissionsDesc": "RadioSphere.be是一個可從任何現代瀏覽器訪問的網站。無需安裝。該網站不使用第三方Cookie。",
    "privacy.security": "安全性",
    "privacy.securityDesc": "由於不收集或傳輸個人資料，因此不存在資料洩露風險。您的收藏和偏好永遠不會離開您的裝置。",
    "privacy.contact": "聯絡我們",
    "privacy.contactDesc": "如有關於本隱私政策的任何問題，請透過以下方式聯絡我們：",
    "player.selectStation": "選擇一個電臺開始收聽",
    "home.greeting": "你好 👋",
    "home.recentlyPlayed": "最近收聽",
    "home.popularStations": "熱門電臺",
    "home.localPopular": "熱門電臺",
    "home.exploreByGenre": "按型別探索",
    "home.yourFavorites": "你的收藏",
    "home.weeklyDiscoveries": "每週發現",
    "home.popularNearYou": "您附近的熱門電臺",
    "home.noFavorites": "新增收藏以在此檢視",
    "search.title": "搜尋",
    "search.placeholder": "搜尋電臺...",
    "search.country": "國家",
    "search.selectCountry": "選擇國家",
    "search.clearCountry": "清除國家",
    "search.resetFilters": "重置篩選",
    "search.notFoundTitle": "找不到您喜歡的電臺？",
    "search.notFoundAddOn": "您可以直接在以下網站新增：",
    "search.notFoundEmailUs": "我們也可以為您嘗試新增：請傳送電子郵件至",
    "inAppBrowser.warning": "為了獲得更好的體驗，請在您常用的瀏覽器中開啟 RadioSphere.be。",
    "inAppBrowser.openExternal": "在瀏覽器中開啟",
    "search.addStationSubject": "Adding a new station",
    "search.noResults": "未找到結果",
    "search.networkError": "網路錯誤。無法連線電臺伺服器。",
    "search.countriesError": "無法載入國家列表。",
    "search.retry": "重試",
    "search.useFilters": "使用搜尋或篩選器查詢電臺",
    "search.genre": "型別",
    "search.language": "語言",
    "search.loadMore": "更多電臺",
    "search.loadingMore": "載入中...",
    "search.sortPopularity": "人氣",
    "search.sortAZ": "A-Z",
    "search.sortClicks": "點選數",
    "search.resultsCount": "個電臺",
    "favorites.title": "收藏",
    "favorites.empty": "暫無收藏",
    "favorites.emptyDesc": "點選電臺的心形圖示將其新增到收藏",
    "favorites.sortName": "A-Z",
    "favorites.sortCountry": "按國家",
    "favorites.unknownCountry": "未知國家",
    "favorites.sortGenre": "按型別",
    "favorites.unknownGenre": "未知型別",
    "favorites.viewList": "列表",
    "favorites.viewMedium": "縮圖",
    "favorites.viewLarge": "大縮圖",
    "favorites.viewSmall": "小縮圖",
    "premium.title": "RadioSphere.be 高階版",
    "premium.subtitle": "終極廣播體驗",
    "premium.active": "高階版已啟用",
    "premium.sleepTimer": "睡眠定時器",
    "premium.sleepTimerDesc": "在可配置的延遲後自動停止播放",
    "premium.androidAuto": "Android Auto",
    "premium.androidAutoDesc": "直接從Android Auto控制RadioSphere.be",
    "premium.chromecast": "Chromecast",
    "premium.chromecastDesc": "透過Chromecast將電臺投射到電視或連線的揚聲器",
    "premium.recorder": "錄音機",
    "premium.recorderDesc": "將節目錄製為MP3，最多可回退5分鐘",
    "premium.monthly": "一次性購買 — 9.99€",
    "premium.buyLifetime": "永久解鎖",
    "premium.priceNote": "參考價格。最終金額可能因國家而異。",
    "premium.yearly": "",
    "premium.yearlySave": "",
    "premium.cancel": "恢復購買",
    "premium.disclaimer": "一次性購買，終身使用。無訂閱。",
    "premium.comingSoon": "即將推出",
    "premium.passwordPlaceholder": "輸入訪問程式碼",
    "premium.unlock": "解鎖",
    "premium.lock": "鎖定高階版",
    "premium.wrongPassword": "程式碼錯誤",
    "premium.unlocked": "高階版已解鎖！",
    "sleepTimer.title": "睡眠定時器",
    "sleepTimer.desc": "在設定時間後自動停止播放",
    "sleepTimer.off": "關閉",
    "sleepTimer.active": "活動",
    "sleepTimer.remaining": "剩餘",
    "sleepTimer.cancel": "取消定時器",
    "sleepTimer.stopped": "播放已自動暫停。",
    "sleepTimer.custom": "自定義",
    "sleepTimer.customPlaceholder": "分鐘",
    "sleepTimer.customGo": "開始",
    "sleepTimer.15": "15分鐘",
    "sleepTimer.30": "30分鐘",
    "sleepTimer.45": "45分鐘",
    "sleepTimer.60": "1小時",
    "sleepTimer.90": "1小時30分",
    "sleepTimer.120": "2小時",
    "player.nowPlaying": "正在播放",
    "player.streamError": "播放錯誤",
    "player.streamErrorDesc": "無法播放此流。請嘗試其他電臺。",
    "player.error": "錯誤",
    "player.streamUnavailable": "此電臺沒有流媒體URL。",
    "player.visitWebsite": "訪問網站",
    "player.timeout": "超時",
    "player.timeoutDesc": "流媒體無響應。請嘗試其他電臺。",
    "player.unexpectedError": "意外錯誤",
    "player.unexpectedErrorDesc": "發生錯誤。請重試。",
    "ssl.title": "不安全連線",
    "ssl.description": "使用未加密連線（HTTP）。此問題來自廣播伺服器，而非RadioSphere.be。",
    "ssl.technical": "此電臺的音訊流不符合當前的SSL/TLS加密標準。RadioSphere.be無法保證此連線的安全性。",
    "ssl.acceptRisk": "自行承擔風險收聽",
    "exit.title": "關閉應用？",
    "exit.description": "再按一次返回鍵退出RadioSphere。",
    "exit.confirm": "退出",
    "common.cancel": "取消",
    "settings.title": "設定",
    "settings.language": "語言",
    "settings.languageDesc": "選擇介面語言",
    "settings.french": "Français",
    "settings.english": "English",
    "settings.dataWarning": "資料使用",
    "settings.dataWarningDesc": "收聽廣播電臺會使用您的網路連線，可能消耗移動資料。建議使用Wi-Fi進行長時間收聽。",
    "settings.dataDisclaimer": "本地資料",
    "settings.dataDisclaimerDesc": "您的收藏和偏好僅儲存在您的裝置上。不會將個人資料傳送到任何伺服器。",
    "settings.radioSource": "電臺來源",
    "settings.radioSourceDesc": "電臺列表由Radio Browser提供，這是一個免費的開源社群API，索引了全球超過50,000個廣播電臺。",
    "settings.radioSourceLink": "訪問Radio Browser",
    "settings.radioSourceAddStation": "新增電臺",
    "settings.analytics": "受眾測量",
    "settings.analyticsDesc": "RadioSphere.be使用Umami Analytics，一款尊重隱私且符合GDPR的分析解決方案。",
    "settings.analyticsNoCookies": "無跟蹤Cookie",
    "settings.analyticsAnonymous": "完全匿名化的資料",
    "settings.analyticsGDPR": "符合GDPR",
    "settings.analyticsUsage": "僅測量全域性使用情況（頁面瀏覽量、使用的功能）",
    "settings.analyticsLearnMore": "瞭解更多關於Umami",
    "favorites.manage": "管理收藏",
    "favorites.export": "匯出為CSV",
    "favorites.import": "匯入CSV",
    "favorites.share": "分享我的收藏",
    "favorites.exported": "收藏已匯出",
    "favorites.imported": "個收藏已匯入",
    "favorites.importError": "匯入錯誤",
    "favorites.refreshingMetadata": "正在獲取後設資料...",
    "favorites.metadataRefreshed": "後設資料已更新",
    "favorites.unavailableStations": "未找到電臺",
    "favorites.unavailableDesc": "這些電臺已不在Radio Browser中列出，可能不再可用：",
    "favorites.understood": "知道了",
    "favorites.noFavoritesToExport": "沒有可匯出的收藏",
    "favorites.refreshMetadata": "更新後設資料",
    "settings.privacyPolicy": "隱私政策",
    "settings.reopenWelcome": "重新開啟歡迎頁面",
    "settings.resetApp": "重置應用",
    "settings.resetAppDesc": "刪除所有收藏、最近電臺和偏好設定",
    "settings.resetConfirm": "確定嗎？此操作不可撤銷。",
    "settings.resetDone": "應用已重置",
    "settings.resetButton": "全部刪除",
    "premium.restorePurchases": "恢復購買",
    "premium.restoreSuccess": "購買恢復成功",
    "premium.restoreNone": "沒有可恢復的購買",
    "guide.title": "使用指南",
    "guide.button": "使用指南",
    "guide.home": "首頁",
    "guide.homeContent": "首頁顯示您最近收聽的電臺、熱門電臺、快速訪問收藏、每週發現和按型別探索。",
    "guide.search": "搜尋",
    "guide.searchContent": "按名稱搜尋電臺，然後按國家、型別或語言篩選。按人氣、字母順序或點選數排序結果。",
    "guide.favorites": "收藏",
    "guide.favoritesContent": "點選電臺的心形圖示將其新增到收藏。在設定中，您可以將收藏匯出為CSV、匯入或分享。",
    "guide.settings": "設定",
    "guide.settingsContent": "更改介面語言，啟用睡眠定時器，管理收藏（匯出/匯入/分享），檢視電臺來源和隱私政策。",
    "guide.permissions": "許可權",
    "guide.permissionsContent": "RadioSphere.be需要一些許可權才能完全執行：通知允許在鎖屏上顯示播放控制；位置用於檢測附近的Chromecast裝置；儲存訪問許可權用於將錄音儲存到手機。不會收集或傳送任何個人資料。",
    "guide.permissionsContentDesktop": "在網頁版中，RadioSphere.be 不請求任何系統許可權：音訊播放在瀏覽器中原生執行。不收集任何個人資料。如需鎖屏控制、內建 Chromecast 和本地錄製功能，請從 Google Play 安裝免費的 Android 應用。",
    "guide.permissionsContentMobile": "在您的手機上，RadioSphere.be（網頁版）可能會請求顯示播放控制通知的許可權。如需更多功能（Chromecast、裝置本地錄音、鎖屏控制），請從 Google Play 安裝免費的 Android 應用。",
    "guide.permissionsReRequest": "重新請求許可權",
    "guide.permissionsReopenWelcome": "重新載入歡迎頁面",
    "guide.sleepTimer": "睡眠定時器",
    "guide.sleepTimerContent": "設定在您選擇的時間後自動停止播放（15分鐘到2小時或自定義時長）。非常適合伴著廣播入睡。",
    "guide.recorder": "TimeBack Machine",
    "guide.recorderContent": "直接從全屏播放器將您喜愛的節目錄製為MP3。5分鐘緩衝區還允許您倒帶和重新收聽剛剛錯過的內容。按REC開始錄製（最長10分鐘）。",
    "guide.chromecast": "Chromecast",
    "guide.chromecastContent": "透過Chromecast將廣播電臺投射到電視或連線的揚聲器。點選播放器中的Cast圖示開始投射。",
    "welcome.subtitle": "全球廣播觸手可及",
    "welcome.chooseLanguage": "選擇語言",
    "welcome.start": "開始",
    "sidebar.tipeee": "在 Tipeee 支援我們",
    "welcome.stations": "50,000+電臺",
    "welcome.search": "高階搜尋",
    "welcome.favExport": "收藏與匯出",
    "welcome.genres": "25種音樂型別",
    "welcome.sleepTimer": "睡眠定時器",
    "welcome.tbm": "TimeBack Machine",
    "welcome.tbmDesc": "回放直播電臺",
    "genre.60s": "60年代",
    "genre.70s": "70年代",
    "genre.80s": "80年代",
    "genre.90s": "90年代",
    ...
    "genre.mousemusic": "Mouse & Music",
    "cast.castingTo": "正在投射到",
    "cast.controlFromPhone": "從手機控制",
    "cast.connected": "已連線",
    "cast.disconnected": "已斷開",
    "cast.unsupportedBrowser": "Chromecast可在Google Chrome或Android應用中使用。",
    "cast.openInChrome": "在Chrome中開啟以使用Chromecast",
    "player.live": "直播",
    "player.recording": "錄製中",
    "player.recordingStarted": "錄製已開始",
    "player.recordingStopped": "錄製已完成",
    "player.recordingMaxReached": "已達到最大時長（10分鐘）",
    "player.saveRecording": "儲存到手機",
    "player.shareRecording": "分享錄音",
    "player.returnToLive": "返回直播",
    "player.recordPremiumOnly": "錄製是高階版功能",
    "player.fileSaved": "檔案已儲存！",
    "player.backInTime": "回到過去",
    "player.bufferLoading": "正在載入緩衝...",
    "player.recordingNotAvailable": "錄製不可用",
    "player.recordingContinuesLive": "返回直播，錄製繼續中...",
    "player.codec": "編解碼器",
    "player.bitrate": "位元率",
    "player.language": "語言",
    "player.noStreamInfo": "流或Radio Browser未提供資訊",
    "onboarding.title": "歡迎來到RadioSphere.be",
    "onboarding.free": "100%免費",
    "onboarding.freeDesc": "無限制訪問，無需訂閱",
    "onboarding.noAds": "零附加廣告",
    "onboarding.noAdsDesc": "RadioSphere.be不新增任何廣告。電臺可能在其流中包含自己的廣告。",
    "onboarding.tbm": "TimeBack Machine",
    "onboarding.tbmDesc": "倒帶直播廣播",
    "onboarding.cta": "即將登陸Google Play",
    "onboarding.dismiss": "不再顯示",
    "tbmQuota.title": "想要無限制地時間旅行？",
    "tbmQuota.description": "在網頁版中，TimeBack Machine 有所限制：最多回放 2 分鐘，錄製最長 5 分鐘，移動端每天總配額為 10 分鐘以確保穩定性。Google Play 上提供的高階版可回放最多 5 分鐘，錄製最長 30 分鐘，無配額限制。",
    "tbmQuota.cta": "在Google Play下載",
    "tbmQuota.continueLive": "繼續直播",
    "tbmQuota.warning": "在我們的應用中享受無限制的TimeBack Machine！",
    "home.androidTitle": "RadioSphere.be Android版",
    "home.androidDesc": "隨時隨地收聽您喜愛的電臺，配備Android Auto、Chromecast和TimeBack Machine。",
    "home.comingSoon": "即將推出",
    "notFound.message": "哎呀！頁面未找到",
    "notFound.backHome": "返回首頁",
    "footer.poweredByPrefix": "由出色的",
    "footer.poweredBySuffix": "提供支援。感謝Alex Segler的社群專案。",
    "footer.createdBy": "由Franck Malherbe建立",
    "aria.play": "播放",
    "aria.pause": "暫停",
    "aria.addFavorite": "新增到收藏",
    "aria.removeFavorite": "從收藏中移除",
    "aria.close": "關閉",
    "aria.refresh": "重新整理",
  },
  tr: {
...
// Ukrainian — full native translation. We deliberately do NOT seed from Russian.
(translations as Record<string, Record<string, string>>)["uk"] = {
  "seo.title": "RadioSphere — Безкоштовне радіо без реклами | TimeBack Machine",
  "seo.description": "Слухайте понад 50 000 безкоштовних радіостанцій з усього світу. Унікально: TimeBack Machine дозволяє перемотати будь-яку станцію до 30 хвилин назад. Без реклами, без реєстрації.",
  "nav.home": "Головна",
  "nav.search": "Пошук",
  "nav.explore": "Пошук і огляд",
  "nav.favorites": "Обране",
  "nav.premium": "Premium",
  "nav.settings": "Налаштування",
  "nav.about": "Про застосунок",
  "sidebar.stationCount": "Понад 50 000 радіостанцій у 230+ країнах, безкоштовно, без реєстрації, без доданої реклами.",
  "sidebar.tbmTeaser": "Наша ексклюзивна функція: TimeBack Machine — перемотуйте живе радіо, переслуховуйте останні 5 хвилин, записуйте передачі у форматі MP3. Онлайн-плеєр, який дозволяє повернути час назад.",
  "sidebar.tbmHowItWorks": "Як це працює?",
  "sidebar.podcastTeaser": "Бажаєте послухати подкаст?",
  "tbmModal.title": "TimeBack Machine — як це працює?",
  "tbmModal.intro": "TimeBack Machine — це ексклюзив RadioSphere.be, який змінює правила прослуховування онлайн-радіо. Більше ніколи не пропускайте важливих моментів у прямому ефірі!",
  "tbmModal.bufferTitle": "🔄 Розумний буфер (5 хвилин)",
  "tbmModal.bufferDesc": "Щойно ви вмикаєте станцію, RadioSphere.be автоматично записує останні 5 хвилин у круговий буфер. Нічого вмикати не треба: усе відбувається автоматично та непомітно.",
  "tbmModal.rewindTitle": "⏪ Перемотування прямого ефіру",
  "tbmModal.rewindDesc": "Пропустили новину, пісню чи ключовий момент? Відкрийте TimeBack Machine і перемотайте до 5 хвилин назад. Користуйтеся кнопками -15с/+15с або тягніть смугу часу для точної навігації.",
  "tbmModal.recordTitle": "🔴 Запис у MP3",
  "tbmModal.recordDesc": "Натисніть REC, щоб записати до 10 хвилин ефіру у форматі MP3 безпосередньо з плеєра. Ідеально для збереження інтерв'ю, треків чи цілих передач.",
  "tbmModal.iconTitle": "💡 Блимаюча іконка TBM",
  "tbmModal.iconDesc": "Коли іконка TBM блимає у плеєрі, це означає, що буфер активний і безперервно записує. Натисніть, щоб відкрити TimeBack Machine і отримати доступ до останніх хвилин прослуховування.",
  "tbmModal.liveTitle": "📡 Повернення до ефіру",
  "tbmModal.liveDesc": "У будь-який момент натисніть «LIVE», щоб миттєво повернутися до живого ефіру вашої станції.",
  "tbmModal.close": "Зрозуміло",
  "app.downloadTitle": "Мобільний застосунок",
  "app.downloadDesc": "Слухайте свої радіостанції будь-де з Android-застосунком.",
  "app.downloadBtn": "Незабаром",
  "footer.tagline": "Преміальний веб-плеєр для прослуховування тисяч радіостанцій з усього світу.",
  "footer.links": "Корисні посилання",
  "footer.contact": "Контакти",
  "footer.rights": "Усі права захищені.",
  "privacy.title": "Політика конфіденційності",
  "privacy.lastUpdated": "Останнє оновлення",
  "privacy.dataCollection": "Збір даних",
  "privacy.dataCollectionDesc": "RadioSphere.be не збирає жодних особистих даних. Реєстрація для користування сервісом не потрібна. Ми не відстежуємо ваші звички прослуховування й не передаємо інформацію третім особам.",
  "privacy.localStorage": "Локальне сховище",
  "privacy.localStorageDesc": "Усі дані зберігаються виключно на вашому пристрої через локальне сховище браузера:",
  "privacy.localStorageFavorites": "Ваші улюблені станції",
  "privacy.localStorageLang": "Ваша мова інтерфейсу",
  "privacy.localStorageRecent": "Нещодавно прослухані станції",
  "privacy.localStoragePrefs": "Ваші налаштування інтерфейсу",
  "privacy.analytics": "Вимірювання аудиторії (Umami Analytics)",
  "privacy.analyticsDesc": "Ми використовуємо Umami Analytics — рішення для аналітики, що поважає приватність і відповідає GDPR. Umami не збирає особистих даних, не використовує файли cookie, усі дані анонімні. Ми відстежуємо лише агреговану статистику використання (відвідані сторінки, використані функції), щоб покращувати сервіс. Umami працює на захищених хмарних серверах постачальника.",
  "privacy.analyticsNoCookies": "Не використовуються відстежувальні cookie",
  "privacy.analyticsAnonymous": "Повністю анонімні дані",
  "privacy.analyticsGDPR": "Відповідає GDPR",
  "privacy.analyticsNoPersonal": "Особисті дані не збираються",
  "privacy.analyticsLearnMore": "Дізнатися більше про політику Umami",
  "privacy.thirdParty": "Сторонні сервіси",
  "privacy.thirdPartyDesc": "Аудіопотоки надаються безпосередньо радіостанціями через спільнотний API Radio Browser (radio-browser.info). RadioSphere.be не контролює контент, який транслюють станції. Аудіопотоки можуть містити рекламу, вставлену самими станціями — RadioSphere.be не може її фільтрувати чи блокувати.",
  "privacy.thirdPartyUmami": "Umami Analytics (cloud.umami.is) використовується для анонімного вимірювання трафіку сайту. Файли cookie не використовуються, особисті дані не збираються. Створюється лише агрегована та анонімна статистика.",
  "privacy.permissions": "Веб-браузер",
  "privacy.permissionsDesc": "RadioSphere.be — це сайт, доступний з будь-якого сучасного браузера. Встановлення не потрібне. Сайт не використовує сторонні cookie. Для збереження ваших налаштувань використовується лише локальне сховище браузера (localStorage).",
  "privacy.security": "Безпека",
  "privacy.securityDesc": "Оскільки особисті дані не збираються та не передаються, ризик витоку даних відсутній. Ваше обране та налаштування ніколи не покидають ваш пристрій.",
  "privacy.contact": "Контакти",
  "privacy.contactDesc": "З будь-яких питань щодо цієї політики конфіденційності зв'яжіться з нами:",
  "player.selectStation": "Оберіть станцію, щоб почати слухати",
  "home.greeting": "Привіт 👋",
  "home.recentlyPlayed": "Нещодавно прослухані",
  "home.popularStations": "Популярні станції",
  "home.localPopular": "Популярні станції",
  "home.exploreByGenre": "За жанрами",
  "home.yourFavorites": "Ваше обране",
  "home.weeklyDiscoveries": "Відкриття тижня",
  "home.popularNearYou": "Популярні поруч з вами",
  "home.noFavorites": "Додайте обране, щоб побачити його тут",
  "search.title": "Пошук",
  "search.placeholder": "Шукайте станцію...",
  "search.country": "Країна",
  "search.selectCountry": "Оберіть країну",
  "search.clearCountry": "Скинути країну",
  "search.resetFilters": "Скинути фільтри",
  "search.notFoundTitle": "Не знаходите улюблену станцію?",
  "search.notFoundAddOn": "Ви можете додати її напряму на",
  "search.notFoundEmailUs": "Ми також можемо спробувати додати її за вас: напишіть нам на",
  "inAppBrowser.warning": "Для кращого досвіду відкрийте RadioSphere.be у звичайному браузері.",
  "inAppBrowser.openExternal": "Відкрити у браузері",
  "search.addStationSubject": "Додавання нової станції",
  "search.noResults": "Нічого не знайдено",
  "search.networkError": "Помилка мережі. Не вдається зв'язатися із сервером станцій.",
  "search.countriesError": "Не вдалося завантажити список країн.",
  "search.retry": "Повторити",
  "search.useFilters": "Скористайтеся рядком пошуку або фільтрами, щоб знайти станції",
  "search.genre": "Жанр",
  "search.language": "Мова",
  "search.loadMore": "Ще станції",
  "search.loadingMore": "Завантаження...",
  "search.sortPopularity": "Популярність",
  "search.sortAZ": "А-Я",
  "search.sortClicks": "Кліки",
  "search.resultsCount": "знайдено станцій",
  "favorites.title": "Обране",
  "favorites.empty": "Немає обраного",
  "favorites.emptyDesc": "Натисніть сердечко на станції, щоб додати її в обране",
  "favorites.sortName": "А-Я",
  "favorites.sortCountry": "За країною",
  "favorites.unknownCountry": "Невідома країна",
  "favorites.sortGenre": "За жанром",
  "favorites.unknownGenre": "Невідомий жанр",
  "favorites.viewList": "Список",
  "favorites.viewMedium": "Мініатюри",
  "favorites.viewLarge": "Великі мініатюри",
  "favorites.viewSmall": "Малі мініатюри",
  "premium.title": "RadioSphere.be Premium",
  "premium.subtitle": "Найкращий досвід прослуховування радіо",
  "premium.active": "Premium активний",
  "premium.sleepTimer": "Таймер сну",
  "premium.sleepTimerDesc": "Автоматично зупиняє відтворення через заданий час",
  "premium.androidAuto": "Android Auto",
  "premium.androidAutoDesc": "Керуйте RadioSphere.be безпосередньо з Android Auto",
  "premium.chromecast": "Chromecast",
  "premium.chromecastDesc": "Транслюйте станції на телевізор або колонку через Chromecast",
  "premium.recorder": "Запис",
  "premium.recorderDesc": "Записуйте передачі в MP3 і перемотуйте до 5 хвилин назад",
  "premium.monthly": "Разова покупка — €9.99",
  "premium.buyLifetime": "Розблокувати назавжди",
  "premium.priceNote": "Орієнтовна ціна. Кінцева сума може відрізнятися залежно від країни.",
  "premium.yearly": "",
  "premium.yearlySave": "",
  "premium.cancel": "Відновити покупку",
  "premium.disclaimer": "Разова покупка, довічний доступ. Без підписки.",
  "premium.comingSoon": "Незабаром",
  "premium.passwordPlaceholder": "Введіть код доступу",
  "premium.unlock": "Розблокувати",
  "premium.lock": "Заблокувати Premium",
  "premium.wrongPassword": "Невірний код",
  "premium.unlocked": "Premium розблоковано!",
  "sleepTimer.title": "Таймер сну",
  "sleepTimer.desc": "Автоматично зупиняє відтворення через заданий час",
  "sleepTimer.off": "Вимкнено",
  "sleepTimer.active": "Активний",
  "sleepTimer.remaining": "Залишилось",
  "sleepTimer.cancel": "Скасувати таймер",
  "sleepTimer.stopped": "Відтворення автоматично призупинено.",
  "sleepTimer.custom": "Інше",
  "sleepTimer.customPlaceholder": "Хвилин",
  "sleepTimer.customGo": "OK",
  "sleepTimer.15": "15 хв",
  "sleepTimer.30": "30 хв",
  "sleepTimer.45": "45 хв",
  "sleepTimer.60": "1 год",
  "sleepTimer.90": "1 год 30 хв",
  "sleepTimer.120": "2 год",
  "player.nowPlaying": "Зараз грає",
  "player.streamError": "Помилка відтворення",
  "player.streamErrorDesc": "Не вдається відтворити цей потік. Спробуйте іншу станцію.",
  "player.error": "Помилка",
  "player.streamUnavailable": "У цієї станції немає URL потоку.",
  "player.visitWebsite": "Відвідати сайт",
  "player.timeout": "Тайм-аут",
  "player.timeoutDesc": "Потік не відповідає. Спробуйте іншу станцію.",
  "player.unexpectedError": "Несподівана помилка",
  "player.unexpectedErrorDesc": "Сталася помилка. Будь ласка, спробуйте ще раз.",
  "ssl.title": "Небезпечне з'єднання",
  "ssl.description": "використовує незашифроване з'єднання (HTTP). Ця проблема пов'язана з сервером радіостанції, а не з RadioSphere.be. Ваші дані можуть бути перехоплені.",
  "ssl.technical": "Аудіопотік цієї станції не відповідає сучасним стандартам шифрування SSL/TLS. RadioSphere.be не може гарантувати безпеку цього з'єднання.",
  "ssl.acceptRisk": "Слухати на власний ризик",
  "exit.title": "Закрити застосунок?",
  "exit.description": "Натисніть «Назад» ще раз, щоб вийти з RadioSphere.",
  "exit.confirm": "Вийти",
  ...
  "settings.french": "Français",
  "settings.english": "English",
  "settings.dataWarning": "Використання даних",
  "settings.dataWarningDesc": "Прослуховування радіо використовує ваше інтернет-з'єднання та може споживати мобільний трафік. Для тривалого прослуховування рекомендуємо Wi-Fi.",
  "settings.dataDisclaimer": "Локальні дані",
  "settings.dataDisclaimerDesc": "Ваше обране та налаштування зберігаються локально на вашому пристрої. Жодні особисті дані не надсилаються на сервери.",
  "settings.radioSource": "Джерело станцій",
  "settings.radioSourceDesc": "Список станцій надається Radio Browser — безкоштовним відкритим спільнотним API, що індексує понад 50 000 радіостанцій з усього світу.",
  "settings.radioSourceLink": "Відвідати Radio Browser",
  "settings.radioSourceAddStation": "Додати станцію",
  "settings.analytics": "Відстеження аудиторії",
  "settings.analyticsDesc": "RadioSphere.be використовує Umami Analytics — рішення, що поважає приватність і відповідає GDPR.",
  "settings.analyticsNoCookies": "Без відстежувальних cookie",
  "settings.analyticsAnonymous": "Повністю анонімні дані",
  "settings.analyticsGDPR": "Відповідає GDPR",
  "settings.analyticsUsage": "Вимірює лише загальне використання (перегляди сторінок, функції)",
  "settings.analyticsLearnMore": "Дізнатися більше про Umami",
  "favorites.manage": "Керувати обраним",
  "favorites.export": "Експорт у CSV",
  "favorites.import": "Імпорт CSV",
  "favorites.share": "Поділитися моїм обраним",
  "favorites.exported": "Обране експортовано",
  "favorites.imported": "обраних імпортовано",
  "favorites.importError": "Помилка імпорту",
  "favorites.refreshingMetadata": "Отримання метаданих...",
  "favorites.metadataRefreshed": "Метадані оновлено",
  "favorites.unavailableStations": "Станції не знайдено",
  "favorites.unavailableDesc": "Цих станцій більше немає у Radio Browser, і вони можуть бути недоступні:",
  "favorites.understood": "Зрозуміло",
  "favorites.noFavoritesToExport": "Немає обраного для експорту",
  "favorites.refreshMetadata": "Оновити метадані",
  "settings.privacyPolicy": "Політика конфіденційності",
  "settings.reopenWelcome": "Знову відкрити вітальну сторінку",
  "settings.resetApp": "Скинути застосунок",
  "settings.resetAppDesc": "Видалити все обране, нещодавні станції та налаштування",
  "settings.resetConfirm": "Ви впевнені? Цю дію не можна скасувати.",
  "settings.resetDone": "Застосунок скинуто",
  "settings.resetButton": "Видалити все",
  "premium.restorePurchases": "Відновити покупки",
  "premium.restoreSuccess": "Покупки успішно відновлено",
  "premium.restoreNone": "Немає покупок для відновлення",
  "guide.title": "Посібник користувача",
  "guide.button": "Посібник користувача",
  "guide.home": "Головна",
  "guide.homeContent": "На головному екрані показано нещодавно прослухані станції, популярні станції, швидкий доступ до обраного, відкриття тижня та огляд за жанрами.",
  "guide.search": "Пошук",
  "guide.searchContent": "Шукайте станцію за назвою, потім фільтруйте за країною, жанром або мовою. Сортуйте результати за популярністю, алфавітом або кількістю кліків. Завантажуйте більше результатів унизу.",
  "guide.favorites": "Обране",
  "guide.favoritesContent": "Натисніть сердечко на станції, щоб додати її в обране. У налаштуваннях ви можете експортувати обране у CSV, імпортувати його чи поділитися ним.",
  "guide.settings": "Налаштування",
  "guide.settingsContent": "Змінюйте мову інтерфейсу, вмикайте таймер сну, керуйте обраним (експорт/імпорт/спільний доступ), переглядайте інформацію про джерело станцій і політику конфіденційності.",
  "guide.permissions": "Дозволи",
  "guide.permissionsContent": "RadioSphere.be запитує кілька дозволів для повноцінної роботи: сповіщення дозволяють керувати відтворенням з екрана блокування; геолокація потрібна для виявлення сусідніх пристроїв Chromecast; доступ до сховища дозволяє зберігати записи на телефон. Особисті дані не збираються та не надсилаються. Якщо ви випадково відхилили дозвіл, ви можете знову запросити його нижче або перезавантажити вітальну сторінку.",
  "guide.permissionsContentDesktop": "У веб-версії RadioSphere.be не запитує системних дозволів: аудіо відтворюється у браузері. Особисті дані не збираються. Щоб користуватися керуванням із екрана блокування, вбудованим Chromecast та локальним записом, встановіть безкоштовний Android-застосунок з Google Play.",
  "guide.permissionsContentMobile": "На телефоні RadioSphere.be (веб) може запитати дозвіл показувати сповіщення для керування відтворенням. Для розширених функцій (Chromecast, записи на пристрої, керування з екрана блокування) встановіть безкоштовний Android-застосунок з Google Play.",
  "guide.permissionsReRequest": "Запросити дозволи знову",
  "guide.permissionsReopenWelcome": "Перезавантажити вітальну сторінку",
  "guide.sleepTimer": "Таймер сну",
  "guide.sleepTimerContent": "Запрограмуйте автоматичну зупинку відтворення через бажаний час (15 хв до 2 год або власна тривалість). Ідеально, щоб засинати під радіо. Активуйте у Налаштуваннях.",
  "guide.recorder": "TimeBack Machine",
  "guide.recorderContent": "Записуйте улюблені передачі у MP3 безпосередньо з повноекранного плеєра. 5-хвилинний буфер також дозволяє перемотувати й переслуховувати щойно пропущене. Натисніть REC, щоб почати запис (макс. 10 хв). Коли іконка TBM блимає — буфер активний і пише у фоні. Натисніть на блимаючу іконку, щоб відкрити плеєр TimeBack і переслухати останні хвилини.",
  "guide.chromecast": "Chromecast",
  "guide.chromecastContent": "Транслюйте радіостанції на телевізор або колонку через Chromecast. Натисніть іконку Cast у плеєрі, щоб почати трансляцію.",
  "welcome.subtitle": "Світове радіо у ваших руках",
  "welcome.chooseLanguage": "Оберіть мову",
  "welcome.start": "Розпочати",
  "sidebar.tipeee": "Підтримайте нас на Tipeee",
  "welcome.stations": "50 000+ станцій",
  "welcome.search": "Розширений пошук",
  "welcome.favExport": "Обране та експорт",
  "welcome.genres": "25 музичних жанрів",
  "welcome.sleepTimer": "Таймер сну",
  "welcome.tbm": "TimeBack Machine",
  "welcome.tbmDesc": "Перемотування прямого ефіру",
  "genre.60s": "60-ті",
  "genre.70s": "70-ті",
  "genre.80s": "80-ті",
  "genre.90s": "90-ті",
  "genre.ambient": "Ембієнт",
  "genre.blues": "Блюз",
  "genre.chillout": "Чілаут",
  "genre.classical": "Класична",
  "genre.country": "Кантрі",
  "genre.electronic": "Електронна",
  "genre.funk": "Фанк",
  "genre.hiphop": "Хіп-хоп",
  "genre.jazz": "Джаз",
  "genre.latin": "Латино",
  "genre.metal": "Метал",
  "genre.news": "Новини",
  ...
  "genre.world": "Світова",
  "genre.mousemusic": "Mouse & Music",
  "cast.castingTo": "Трансляція на",
  "cast.controlFromPhone": "Керування з телефону",
  "cast.connected": "Підключено",
  "cast.disconnected": "Відключено",
  "cast.unsupportedBrowser": "Chromecast доступний у Google Chrome або Android-застосунку.",
  "cast.openInChrome": "Відкрийте у Chrome, щоб користуватися Chromecast",
  "player.live": "ЕФІР",
  "player.recording": "Запис",
  "player.recordingStarted": "Запис розпочато",
  "player.recordingStopped": "Запис завершено",
  "player.recordingMaxReached": "Досягнуто максимальної тривалості (10 хв)",
  "player.saveRecording": "Зберегти на телефон",
  "player.shareRecording": "Поділитися записом",
  "player.returnToLive": "Повернутися до ефіру",
  "player.recordPremiumOnly": "Запис — функція Premium",
  "player.fileSaved": "Файл збережено!",
  "player.backInTime": "Назад у часі",
  "player.bufferLoading": "Завантаження буфера...",
  "player.recordingNotAvailable": "Запис недоступний",
  "player.recordingContinuesLive": "Повернення до ефіру, запис триває...",
  "player.codec": "Кодек",
  "player.bitrate": "Бітрейт",
  "player.language": "Мова",
  "player.noStreamInfo": "Інформація від потоку чи Radio Browser відсутня",
  "onboarding.title": "Ласкаво просимо до RadioSphere.be",
  "onboarding.free": "100% безкоштовно",
  "onboarding.freeDesc": "Необмежений доступ без підписки",
  "onboarding.noAds": "Нуль доданої реклами",
  "onboarding.noAdsDesc": "RadioSphere.be не додає рекламу. Станції можуть вставляти власну рекламу у свої потоки.",
  "onboarding.tbm": "TimeBack Machine",
  "onboarding.tbmDesc": "Перемотуйте прямий ефір у будь-який момент",
  "onboarding.cta": "Незабаром у Google Play",
  "onboarding.dismiss": "Більше не показувати",
  "tbmQuota.title": "Хочете подорожувати в часі без обмежень?",
  "tbmQuota.description": "У вебі TimeBack Machine обмежений: перемотування до 2 хвилин назад і запис до 5 хвилин максимум, із загальним лімітом 10 хв/день на мобільному задля стабільності. Преміум-версія у Google Play дозволяє перемотувати до 5 хвилин і записувати до 30 хвилин без квот.",
  "tbmQuota.cta": "Завантажити з Google Play",
  "tbmQuota.continueLive": "Продовжити ефір",
  "tbmQuota.warning": "Користуйтеся TimeBack Machine без обмежень у нашому застосунку!",
  "home.androidTitle": "RadioSphere.be на Android",
  "home.androidDesc": "Слухайте улюблені станції будь-де з Android Auto, Chromecast та TimeBack Machine.",
  "home.comingSoon": "Незабаром",
  "notFound.message": "Ой! Сторінку не знайдено",
  "notFound.backHome": "Повернутися на головну",
  "footer.poweredByPrefix": "Працює на чудовому ",
  "footer.poweredBySuffix": ". Окрема подяка Alex Segler за цей спільнотний проєкт.",
  "footer.createdBy": "Створено Franck Malherbe",
  "aria.play": "Грати",
  "aria.pause": "Пауза",
  "aria.addFavorite": "Додати в обране",
  "aria.removeFavorite": "Видалити з обраного",
  "aria.close": "Закрити",
  "aria.refresh": "Оновити",
};
